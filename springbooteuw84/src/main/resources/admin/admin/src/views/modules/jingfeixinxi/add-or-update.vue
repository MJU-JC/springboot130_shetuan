<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="经费金额" prop="jingfeijine">
          <el-input v-model="ruleForm.jingfeijine" 
              placeholder="经费金额" clearable  :readonly="ro.jingfeijine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经费金额" prop="jingfeijine">
              <el-input v-model="ruleForm.jingfeijine" 
                placeholder="经费金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='jingfeijine'){
            this.ruleForm.jingfeijine = obj[o];
	    this.ro.jingfeijine = true;
            continue;
          }
          if(o=='shenqingliyou'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jingfeixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingfeixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
